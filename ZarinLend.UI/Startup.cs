...
namespace Web.UI
{
    ...
    public class Startup
    {
        ...
        {
            //foreach (WorkFlowFormEnum item in b)
            //{
            //    var sss = item.ToDictionary();
            //    var d = item.ToDisplay();
            //}
            //services.AddAutofac();
            ...
            services.AddDbContext(Configuration, CurrentEnvironment);
            ...
            //moved to 'BuildAutofacServiseProvider' method
            ...
            services.AddWebMarkupMinService();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseNotFound404Unauthorized401Middleware();

            //if (!env.IsDevelopment())
            //    app.UseHttpsRedirection();            

            //TODO : R & D about 'Compression'
            if (!env.IsDevelopment())
            {
