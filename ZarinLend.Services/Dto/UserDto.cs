...
{
    public class UserDto : IHaveCustomMapping, IBaseDTO, IValidatableObject
    {
        ...
        [StringLength(100,  ErrorMessageResourceType = typeof(ResourceFile), ErrorMessageResourceName = nameof(ResourceFile.StringLengthMessage) )]
        ...
        //برای چک کردن منطق تجاری برنامه مناسب است نه مثلا چک کردن نام کاربری تکراری
